...
<<declare $ghosts = "true">>
<<declare $princess = "true">>
<<declare $kindaparent = "games">>
<<declare $howlong = "recent">>
<<declare $future = "nopromises">>


Missed call from Sixty-Something
->i saw you called?
I just wanted to get back to you, you were asking about our old furniture? But we can just text if that’s easier.
...
->I actually sleep great, I didn’t get everything from you lol
...
->I do!
Good 🙂
So to your question: most of what we had back then came from Margret’s family’s old house. Almost all of your childhood furniture was originally Margret's.
->ah right, that makes sense
Yeah, she was a real blessing. I was pretty alone and felt a little helpless until she swooped in and got me settled.
->wow, yeah. Margret, Margret. that old chest came from her too?
Green?
->oh yeah I guess I remembered it more gray but yeah
Yes.
...
OK.
-> AAA insert voice message "Memo 24-01" BBB
<<pause 1 minutes>>
<<jump start3>>
===
...
->oh come on, adults lie to kids all the time
!!
...
Oh of course, my bad!
<<endif>>
->haha exactly. but you don’t remember playing that? or me hiding in the chest for Sneaky Stowaways?
I don't 🙂
->weird
I do remember that "Space Disco" dance though!
->you were so excited about it lol
...
->oh no no, I spent a ton of time there! and then we did that like every Saturday when we were helping out at Margret's.
You’re kidding
...
->right. what did Margaret mean when she said I was special?
...
->in what way?
Look, it's hard to explain, she was a unique individual. She used to be very social and was always the life of the party. But she was never with anyone for a longer period of time. And it seemed like she preferred it that way.
...
-> AAA insert voice message "Memo 24-02" BBB
<<pause 1 minutes>>
<<jump margret3>>
===
...
-> AAA insert voice message "Memo 24-03" BBB
<<pause 1 minutes>>
<<jump margret4>>
===
...
Now I’m parked at the supermarket. I just got back in the car.
<<pause 1 minutes>>
...
The thunder and lightning right now is crazy.
...
->lil ol' Mario me, already looking for a princess haha. little did they know...
All you needed was a mirror haha.
...
But?
-> AAA insert voice message "Memo 24-04" BBB
<<pause 1 minutes>>
<<jump princess2>>
===
...
->hahahahahahah
🙃
->do you remember that old nightstand that doesn’t quite stand right?
Of course! You still have that?!
->haha yeah, I do. was that from Margret as well?
No, it was a gift.
->From whom?
Juno, an old friend.
...
What's there really to tell? It was nothing terribly dramatic, just one of those things where it's hard to say exactly what happened and then years go by without contact and then you're reminded of it decades later and it's a bit overwhelming all at once
->damn that's a lot, I'm sorry
Thanks. Why’d you ask?
->I couldn’t remember having heard her name before, I was curious
No, I mean the nightstand.

-> AAA insert voice message "Memo 24-05" BBB
<<pause 1 minutes>>
<<jump princess5>>
===
...
->it’s weird
It’s not thaaaat weird.
->no, no, sorry, I meant with the nightstand. Like with you and Juno, it felt like I was remembering someone too
Huh.
->did I know her?
Juno?
...
---
Yes, could be.
->oh hey what was that song you used to sing when I was falling asleep?
Hi! Which one?
...
->huh?
The person you smelled in the nightstand drawer??
...
->a shared ghost
Ours?
->yeah, maybe that's what makes a household special
Ghosts?
->yeah, like whatever ghosts were haunting your home
I do think people play a role in that.
->like if a ghost haunts a home with no one in it is it really haunting? haha
Don't you think?
...
title:ghosts2
---
Funny, I didn't expect to still know the words.
...
title:storytime1
---
(I understood the metaphor, I mean.)
...
->I guess whenever I've heard something from you the last few years I feel like you've been more stable
...
A bit sudden for a surprise therapy session, don't you think?
->oh come on
I'm just joking. But we haven't talked this much in ages. And we've slipped into a very normal sort of conversation and you're reaching out to ask how I'm doing. It's all very fast in a way.
->I'm sorry, I didn't mean to overwhelm you
That's not what I'm saying! Just that it's a bit
surreal maybe
...
title:storytime3
---
I can't help getting the impression that you're throwing a whole lot into your work even though you're doing alright for yourself.
->I mean, you always did too
Well, I wish I didn’t have to. It certainly didn’t help my mood.
->but you did have to
I guess.
->because of me
...
->wait you know En and I are (and will be) dating other people, right?
...
->no just kidding
Haha.
-> AAA insert voice message "Memo 24-06" BBB
<<pause 1 minutes>>
<<jump fight2>>
===
...
I do.
->ok wait, but then explain to me what this birthday thing was all about!?
What??
->sometimes you just kind of say shit without really thinking about what you’re saying or why or what you’re trying to get at
Sorry?
->it’s always some off-the-cuff emotional response that doesn’t actually mean anything, but you also get mad if I don’t engage
No, that’s not right.
...
-> AAA insert voice message "Memo 24-07" BBB
<<pause 2 minutes>>
<<jump fight3>>
===
...
No?
-> AAA insert voice message "Memo 24-08" BBB
<<pause 1 minutes>>
<<jump fight4>>
===
...
Oh
->I feel like it always started with this feeling
What feeling?
->that you were starting down a spiral or like starting to fall and then giving into the gravity more and more
Hm
...
-> AAA insert voice message "Memo 24-09" BBB
<<pause 1 minutes>>
<<jump arcade2>>
===
...
No.
->but it can't not have been you, I mean like 80 Plays is a game we came up with together
It is?
->and I never went to the arcade with anyone else and I mean most of the time you'd wait outside. no, you never came inside
Right.
-> AAA insert voice message "Memo 24-10" BBB
<<pause 1 minutes>>
<<jump arcade3>>
===
...
No, it's not allowed.
->and if we were avoiding the guards, did we sneak into the arcade???
...
->I mean try telling the story so it doesn't make you sound like the victim
    ...
    -> AAA insert voice message "Memo 24-11" BBB
    <<pause 15 seconds>>
    Look
    ->yeah?
...
->yeah
And I was trying to look through them
->still standing
Huh?
...
->what do you mean?
Doesn't it sound a bit like an imagined, I don't know, alternate me?
->huh
...
You keep asking and there's all these gaps.
...
->sure
On the phone?
->not right now, I'm on a train that's really full. I can write though
->not right now, I'm at work. I can write though
->not right now, I'm still too worked up. I can write though
...
->you and me?
Yes.
->for whatever reason, I keep thinking about Margret
    <<jump endMargret>>
->I feel like my head is full of ghosts
    <<set $ghosts to "true">>
    <<jump endGhosts>>
->that princess keeps coming to mind
...
I suppose we didn't really come to any resolution.
->about her?
Yeah.
->yeah but I don't think it's the partnership thing
That's keeping you busy?
->I mean, that's a more or less ever-present topic for me, but yeah
Something about your relationship with her?
->yeah I guess
She really cared for you, you know?
->I do. I think that's kind of what's getting at me. The way you talked about her, it felt like she understood me in a way
Right.
->and I guess I feel weird about not having felt that or like given her her proper due when she was around
I don't think she was expecting that from you, you were just a kid!
->no I know
But I understand, I think. What do you feel like she understood about you?
->I mean you said she thought I was special haha. But also how she asked you to let me be when I was lost in my own world
Yeah.
->makes me wonder why, or if she knew that something about that was important for me
You know, she made fun of me when I complained about not knowing what was going on inside you. Said it was like the tree looking for the apple, not realizing it had fallen so close by.
->haha did you do that often?
    Haha no, not too often, just when I'd forget where you'd gotten your weirdness from.
    ->like how we both sometimes just needed a little distance to the world?
        <<set $kindaparent to "absent">>
        Hm, I hadn't thought about that specifically, but I guess so. That's when the two of you would play, huh?
        ->me and Margret?
        You and Arcade Me. You and your fictional version of me.
        ->right
    ->like how I was always making up games, kinda like you taught me to? and then I'd disappear into them
        <<set $kindaparent to "games">>
        Yeah, right. Funny, again, I think I've always thought of that as your thing, but of course I did point you that way. Or we did.
        ->we? You and Margret?
        Me and Arcade Me. Me and your fictional version of me.
        ->right
->oh did you complain about me often?
    Come on now. No, not often. Just when we were having trouble talking with each other. And I'd get stuck in my head trying to understand how we could be so different and not be able to see all the overlap.
    ->like how we both sometimes just needed a little distance to the world?
        <<set $kindaparent to "absent">>
        Hm, I hadn't thought about that specifically, but I guess so. That's when the two of you would play, huh?
        ->me and Margret?
...
Funny in a way, that it wasn't her. That she didn't fill that role.
->I don't think she could have. You'd keep her out too, you know
Don't say that.
->it's true! but I'm not trying to make you feel bad. about you and Margret. Maybe she saw them too and that's why she got me
Them like other me?
->yeah
Huh.
<<if $kindaparent == "absent">>
->like she could also still see you even when you were absent
<<jump absent>>
<<elseif $kindaparent == "games">>
->like she saw us playing games together whenever I was zoning out
<<jump games>>
<<endif>>
===
...
---
What do you mean?
->Like when we talked about how our house was haunted by our stories
Right. And now they're haunting you?
->I mean I'd think both of us took our fair share with us from that place
Well it wouldn't have been fair to leave them all there for the next tenants to deal with
->haha
But you seem to have gotten it worse than me.
->you think?
Or maybe there were just already so many to contend with, from before.
->the ghosts of your life
The Ghosts of My Life
->haha exactly
Haha!
->and that's why they all flocked to me?
This is getting a little abstract haha.
->yeah but I mean aren't you just as busy with our history as I am?
In a way, yes, of course, but it's also true that's your whole history, while I have my own childhood before that too.
->well yeah
And it has to be said, you are a magnet for ghosts.
->what's that supposed to mean?
With that fantastical imagination of yours?
->ha. ha. though that probably is a part of it
And I never met a ghost of someone who was still alive...
->I guess some people go hunting for ghosts when they miss someone who's absent.
    <<set $kindaparent to "absent">>
    Me, you mean?
    ->yeah
    Too abstract, like I said. This metaphor is getting pretty mixed up for me.
    ->granted, but I also think you're avoiding the point
        Can you help me see what it is?
        ->I don't know, I was hoping we could come together on at least this
    ->if this were just a stupid metaphor I don't think you would have been crying outside the arcade yesterday
        Thanks.
        ->but doesn't it make you wonder at least a little??
->well sometimes ghosts were all who was there to play games with me.
    <<set $kindaparent to "games">>
    What about Clarence?
    ->what about Clarence?
    He was no ghost.
    ->no, but he probably would have come over more often if our place didn't seem so haunted
        Oh right, he told you he thought we were weird once, didn't he?
        ->that's what I'm saying
    ->no, but he probably would have come over more if I'd played normal games like "house" or "doctor" instead of our weird games
        If you'd been into him, you mean?
        ->oh god that's not what I meant
    Anyway, he came over all the time!
    ->not how I remember it, not when we got older

Look, I know we remember things differently.
->I think the last couple of days have shown that to be quite the understatement
Sure, that's true. But what is it you're getting at, with the ghosts and the hauntings?
->I guess that all the spaces between us, our experiences, our memories, are cracks for things to arise that we can't understand
<<if $kindaparent == "absent">>
And also the actual spaces between us you mean?
->yeah, I think when you were gone or not available, then that would be a kind of crack as well, in our shared world
<<jump absent>>
<<elseif $kindaparent == "games">>
And the games?
->well that's how you taught me to understand the world so naturally that's the shape things would take that I couldn't understand
<<jump games>>
<<endif>>
===
...
---
Princess?
->the princess I always felt you would have liked me to be.
Come on, I didn't want you to be anything else than what you were.
->I can't say I really believe that
I don't know how to convince you.
->No I know, but I think that's sort of what's getting at me
I don't follow.
->I mean you obviously never said "I want you to be a pretty little princess"
I most certainly did not.
->haha, right. but it's how I interpreted your behavior toward me
Huh.
->I don't think I even had the framework of "princess" in my head until we were talking about Mario or whatever the other day
Right.
-> AAA insert voice message "Memo 24-12" BBB
<<pause 1 minutes>>
<<jump endPrincess2>>
===
...
title:endPrincess2
---
OK, sure. I think I understand.
->so it doesn't make sense arguing about whether or not you wanted me to be a princess when I was growing up
Mmhm. I'm finding it hard to resist re-asserting that it's not at all what I wanted, but I see that that's not your point.
->finally
    Excuse me?
    ->It's just nice that you're making an effort to understand what I'm actually trying to say instead of just reacting to what you hear
    Takes two to tango, huh?
    ->?
    I mean that's what your getting at, right? The way we both react and relate to what we see in each other, instead of taking time to see what's really there.
    ->ok yeah
->exactly haha thank you
    You're welcome 😊
    ->ok but you see what I'm getting at?

So the princess story is something you grew up with, whether or not that's really what I intended, is that what you're saying?
->yeah
OK.
->right, so that's what I think makes more sense when we try to figure these things out, to deal with the stories that are there
Mhmm.
->instead of fighting about who knows the story best. or, you know, who came up with the story in the first place
And when we have different stories?
->yeah, I mean, that's what I'm trying to figure out
Well that's the importance of us talking through these things, right? Hearing what stories are playing through each others' heads?
->yeah
So where does that leave us? I guess we have a lot to untangle.
->or just a lot of knots to compare 😀
Like the arcade, and what our experiences of that night meant for each of us?
->right
And how thinking I wanted you to be a princess affected you?
->yeah
It sounds like a lot to unpack. Not easy.
->well if there's one thing you taught me, it's how to make big scary challenges into something fun, into games
    <<set $kindaparent to "games">>
    Oh god, I hope that's not all you learned from me!
    ->hey, that's on you
    <<jump games>>
->don't tell me you're ready to give up already
    <<set $kindaparent to "absent">>
    "Give up"?
    ->I mean it's not like we haven't touched on your tendency to disappear when you're overwhelmed
    <<jump absent>>
===

title: games
---
You know, I can never really tell if you see our games as a good thing.
->what do you mean?
I mean sometimes you talk about them as useful tools for dealing with tough or complicated things, sometimes you talk about them as a way that we used to bond, but sometimes it sounds like you're ashamed of them or have the feeling they cut you off from others or kept you from facing things head on or something.
->huh
What?
->I mean all of the above I guess
OK?
->well I don't know what you want to hear, it's complicated
Isn't it always.
->it really is!
I know.
->I mean one thing about the way that it cut me off is that they were often pretty inward-facing
What do you mean by that?
->more Solitaire than Go Fish?
Oh OK I see.
But we also played together.
->yeah that's true, but I think even there, I don't know, it's like we were playing in a shared alone-ness
Huh.
->more than it really feeling like a social activity. does that make sense?
I think it does.
I'm trying to figure out if I felt the same.
You didn't really bring many friends over, did you?
->I guess not really. After Clarence made that comment about feeling weird at our place
You felt too self-conscious to invite people over?
->I think so, yeah
Oof.
->I never said he didn't like you
    That's sweet, but that's not really what I mean.
->why should you care?
    Gee thanks.
It's not about me, it's that I don't like the idea that I made our home into a place that you couldn't share with anyone else.
->you didn't really invite people over all too often yourself
That's true, you're right.
Huh.
<<if $ghosts == "true">> 
I guess that's part of what made our home ripe for haunting!
->haha yeah
<<endif>>
It really was just for us in a way, huh?
->yeah I think that's a big part of what I mean
And now?
->now?
How do you feel like it's affecting you today?
->huh
I mean you mentioned the little ways you gameify your workload, but I guess I'm wondering more about your connections with other people? And I mean, something about it has its hook in you, bringing all this up...
->?
<<jump today>>
===
...
title: absent
---
You keep talking about how absent I was when you were growing up. Even before we talked about the night at the arcade. And to some extent I understand what you mean. I was very busy, I wasn't at home as much as your friend's parents might have been. But you used to discribe it as a good thing. Something that allowed you the independence you wished for. And I also know that I was very in my own head sometimes, distracted with my own stuff. But we still had such a strong connection when you were younger. Even if I didn't always understand you.
->yeah?
I just feel like this is suddenly becoming my defining feature.
->but I've been saying other things too
Such as?
->the games, the creativity, the imagination
    Well right, ok, but there half of those memories seem to have not really actually involved me.
    ->oh come on! again with what I'm actually saying!
    ?
    ->those memories still would have been impossible without you, even if you often didn't have the time yourself
->the self-sufficiency, the tenacity, the independence
    OK, I hear you, but that feels like what I was saying before, that that's just kind of a side-effect of the absence you keep emphasizing.
    ->I don't think so! I think those are different things
In a way it all still feels like it all loops back around to my being sort of half there, my
I don't know.
->I don't get it
Me neither.
->look, it sounds like you're starting to spiral again. I mean literally with "it all loops back around"
?
->like you're stuck in this circle of tying everything back to when you're at your lowest
It's hard to stop
once I get going.
->I know
I can feel myself wanting to pull away.
->yeah I mean this is what would happen
Yeah?
->yeah, you were constantly working and then also taking care of me
Right.
->and then any time a little bit of feeling had the space to bubble through it would knock you out completely
Hm.
->so yeah it does all "loop back around” but only in that these qualities are tied together by being parts of who you are, right?
Yes, that's a nice way of putting it.
But it doesn't really account for the negative effect it had on others.
On you.
->no, not really
I don't think I've ever asked you if you have similar episodes
->well to be honest, you've never even really directly addressed them or called them "episodes" with me
No?
->no
Oh. I'm sorry.
->I don't really think I do
?
->have episodes like that.
Good.
->but adapting to you having them and dealing with what that meant for me certainly is something I'm still chewing through
Hence this whole saga.
->?
<<jump today>>
===
...
title: today
---
You asked me about some old furniture a few days ago, then I tried to call and you didn't pick up, and then you wrote back to me, and then THAT escalated into figuring out that my inability to support you fully as a child combined with your passion for invention led you to manifest an extended doppelgänger living ghost of me?
->oh that
Hahaha
->right
What's been going on with you to bring this up?
->good question
    <<set $howlong to "recent">>
    <<jump recent>>
->I think it's more longterm than that
    <<set $howlong to "longterm">>
    <<jump longterm>>
===
...
---
And?
->yeah I guess it's something elusive that's been, I don't know, shadowing me
Recently?
->yeah, I guess. An answer that's been coming together to a set of questions maybe
About?
->I don't know, a kind of longing maybe?
For what?
->you're really digging, huh?
    Look I don't want to be pushy.
    ->yeah no, I guess it's only fair to turn it around like this
    Ha!
    ->I think it's something that's been coming up in my close relationships
->I'm thinking!
    Take your time 😊
    ->I think it's something that's been coming up in my close relationships
...
->anyway
    ?
->remember we have very different understandings of partnership
    OK right.
    ->right
    Sorry?
Please continue!
->it's like there's a world inside me that I've forgotten how to share
<<jump aftermath2>>
===
...
---
Oh?
->yeah like something that's been slowly crawling or expanding up my throat and is just now getting out
Oh!
->look it's just a metaphor don't be so squeamish
    OK geez it just sounded a little gross
    but I think I get it. Go on
    ->maybe a sense of loss that's been growing since whenever I lost touch to that other-you
->haha
    Sorry, go on!
    ->maybe a sense of loss that's been growing since whenever I lost touch to that other-you

Oh I see.
->and I guess I've sort of a reached an age where I need to be able to move forward
And you're feeling tied back?
->well I guess, sort of hard to get closure mourning for someone who never existed
Oh huh, when you put it that way...
And something's been stuck because of that?
->it's like there's a world inside me that I've forgotten how to share
<<jump aftermath2>>
===
...
It closes you off?
->I guess, or they offered a way for me to process the connection between my inner world and the world around me
<<if $howlong == "recent">>
They?
->you know, other-you
Ah right.
...
Uh-huh.
<<endif>>
->a way for me to process things openly, to explore my curiousity, my wonder
That's not something you felt like you could do with me?
->AAA insert voice message "Memo 24-13" BBB
<<pause 1 minutes>>
<<jump aftermath3>>
===
...
->it is what it is
    Sure.
->look, I'm not trying to be hurtful
    I know.
And how else has this come up?
->hm, I'm trying to think of an example
Just to help me understand where you're at.
<<if $howlong == "recent">>
-> AAA insert voice message "Memo 24-14" BBB
<<else>>
-> AAA insert voice message "Memo 24-15" BBB
<<endif>>
<<pause 2 minutes>>
<<jump aftermath4>>
===
...
title:aftermath4
---
And that door wants to open again?
->I certainly want it to
And they, "other-me" I guess, helped keep it open when you were younger?
->I think so, yeah
I see.
What do you think would help?
Does it have anything to do with me?
Me now, I mean?
->I guess, for one, I just wish we had the kind of connection where you just know me
Mmhm
->you know, because of our relationship and our history, instead of despite it
Right.
->because I do think that link to my childhood is important for this
Yeah, I mean that definitely makes sense.
And so you think I might be able to help you get that door open?
->I think I did need that link to feel understood, if not entirely held or whatever
That makes sense.
->and I think that I still need that
Mmhm.
->probably not just from one person, but there are parts that only you can know from having been there
I think that's something I can try to be.
->yeah?
    I mean if anything, it's become clear that that won't just happen overnight, but I can work on it.
    ->ok, yeah
->I think so too
    Even if we're not quite there yet
    ->haha right
->I'm not sure I can believe you really
    Well what else can I even offer?
    ->yeah no I don't know
    Can you at least let me try?
    ->to be honest? I'm not totally sure
        <<jump time_apart>>
    ->hm. I think so, yeah
So how do you think we can get there?
->it's hard to see the next step honestly, since we just so quickly get stuck in our old cycles with each other
Maybe they can help?
->huh. how do you mean?
I don't know, but they certainly know or knew sides of both of us that we've otherwise kept from each other.
->yeah that's true
So?
->honestly, I think we may need to start exploring that, our relationships to them, separately
    <<jump time_apart>>
->I mean maybe what we actually need is some kind of exorcism
    <<jump exorcism>>
->maybe we need to make room for them
    <<jump keep>>
===
...
---
Exorcism?!
->yeah, like some kind of proper send-off
Ah haha I see.
->get back to the two of us
Do you see that more like a re-absorption or a farewell?
->good question
Do you know what I mean?
->yeah. I like the sound of re-absorption
    <<jump reabsorption>>
->yeah, let's figure out how to prepare a farewell!
    <<jump farewell>>
->hm not really
    You know, is the goal to figure out who we are without them or to kind of dissolve them back into us, which seems to have been where they came from in the first place, right?
    ->oh, ok, yeah. re-absorption then?
        <<jump reabsorption>>
    ->oh, gotcha, ok. how about a farewell?
        <<jump farewell>>
===
...
Hm.
How about I come visit you? And we can figure out something that makes sense. Maybe it's a kind of ritual or just talking through memories or something. Sharing stories. Learning about them from each other. Playing games 😉
->I'm not sure if I'm quite ready for that yet
    I see.
    ->but this could still be a first step!
    Separately?
    ->yeah
    How do you imagine that? It feels like something that would need us to spend more time together, not less.
    ->I mean we could just keep writing? go through memories, like you said. share stories
    Right.
    ->and try to reacquaint ourselves separately with them
    Me too?
    ->yeah, I mean your last trip to the arcade seemed to create a kind of opening for that
    True.
    ->does that make sense?
    Yeah, I get it.
    <<jump time_apart>>
->that's a nice idea
    Soon?
    ->yeah, I could take a few days off in a couple weeks
    OK!
    ->wow, so spontaneous!
    Haha yeah, but I feel the momentum and, knowing us, it's probably best we made use of that...
    ->yeah that's a good point actually
    See? Maybe I do know you!
    ->don't push it
    Haha.
    ->I like this idea
    Yeah?
    ->yeah. I can keep it all. I mean it was all you to me anyway and now we can really make it so
    That's sweet!
    ->can I call you tomorrow? we can make plans?
    That sounds great.
    Thank you.
    <<jump epilogue>>
===
...
Yes, I like that.
->do you have an idea how?
How about I come visit you? And we can figure out something that makes sense. Maybe it's a kind of goodbye ritual or even something like a funeral or maybe just talking through memories or something. Sharing stories. Playing games 😉
->I'm not sure if I'm quite ready for that yet
    I see.
    ->but this could still be a first step!
    Separately?
    ...
    ->I mean we could just keep writing? go through memories, like you said
    Right.
    ->and kind of try to figure out where they came up and separate those out from memories we share
    Me too?
    ->yeah, I mean your last trip to the arcade seemed to indicate that they'd made their way into your memories too
    True.
    ->does that make sense?
    Yeah, I get it.
    <<jump time_apart>>
...
---
How do you mean?
->acknowledge them as their own person
Ah.
->you know?
I think so.
->like in a way it doesn't really change that much. I'll keep these memories as they are and you can do the same
Huh.
->I mean that could come up for you more as well
How so?
->well I mean given what happened on your last trip to the arcade.
Right.
->Maybe the more you go back to those places or just those memories, the more they'll solidify for you too?
Hm.
Yeah, I think that makes some sense.
Is there a part of this we do together?
->I'm not sure. maybe not?
    <<jump time_apart>>
->I think there definitely could be
    I mean I'd love to hear more about them.
    ->haha
    Well but I mean it, it would be helpful, to separate those stories or memories from the ones we share.
    ->right
    You know?
    ...
    ->maybe even calling 😉
        Oh my!
        ->hahaha. I mean it though
        I mean yeah, of course.
        ->is it ok if I just ring at some point even if I'm between things or like don't have a lot of time?
        Definitely.
        ->and you'll pick up?
        You do know that I still have things to do, RIGHT?
        ->haha yeah no I know
        I'll try my best.
        ->thanks
        Can't wait to hear from you.
        <<jump epilogue>>
    ->how about a visit sometime?
        Oh!
        ->I haven't been back in a while
        That's true.
        ->we could even go to the old arcade together. see what happens
        Haha. Better hurry!
        ->oh right, it's all being torn down, huh?
        It is.
        ->well we'll see what's left of it when I get there!
        Haha sounds good.
        ->can I call you tomorrow? we can make plans?
        That sounds great.
        Thank you.
...
---
Hm..
->I think I just need figure this out by myself. and i think you should too
Yeah
->you don't seem convinced
I mean what do you want me to say? It's not what I prefer, that's for sure.
->I get that
So?
->I feel like you could be a bit more understanding of my needs
    Were we at any point going to talk about my needs?
    ->I feel like we have been this whole time
    Aha
    ->what
    I think we've been having two different conversations.
    ->wouldn't be the first time
    Probably not the last.
    ->I don't know
        <<set $future to "nopromises">>
        <<jump no_contact>>
    ->probably not
        <<set $future to "someday">>
        <<jump no_contact>>        
->is there something that would help you?
    I don't know.
    Knowing that this isn't forever?
    ->I don't think I can promise that
        <<set $future to "nopromises">>
        <<jump no_contact>>
    ->I don't think it will be. I just need time
        <<set $future to "someday">>
        <<jump no_contact>>
===
...
---
Mmhm
->look this isn't me lashing out or whatever
I know
->AAA insert voice message "Memo 24-16" BBB
<<pause 2 minutes>>
<<jump no_contact2>>
===
...
title:no_contact2
---
I do believe you. Of course.
->thank you
But you need to know that this is your choice, not mine.
->I do. I hope you can find some sense in it for yourself
Me too.
->and I hope you can also get something from this
Thank you.
->sure
Well.
...
I'm sorry
This is too strange. I don't think I can.
->I'm sorry.
Yeah
->goodbye.
    <<jump epilogue>>
